...
class WordpressFunctions
{
    static public function handleWordpressFunctions(Environment $twig)
    {
        ...
        $twig->addFunction(
            new TwigFunction(
                'settings_fields', function (string $optionGroup): string {
                    return self::getOutput(
                        function () use ($optionGroup) {
        ...
        $twig->addFunction(
            new TwigFunction(
                'do_settings_sections', function (string $page): string {
                    return self::getOutput(
                        function () use ($page) {
